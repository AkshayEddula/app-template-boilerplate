...
const CHARACTER_LORE: Record<string, string> = {
    health: "Born from the first heartbeat. Vita thrives when you move and hydrate. Neglect fades her light; action makes her burn bright.",
    mind: "A being of pure intellect. Aeris grows clearer with every page read. Feed him knowledge to unlock his true form.",
    career: "Forged in the fires of ambition. He doesn't ask for luck; he asks for discipline. Build your empire, and Forge will stand guard.",
...
export const CharacterCard = ({ categoryKey, xp, scale = 1 }: { categoryKey: string, xp: number, scale?: number }) => {
    ...
    const imageUrl = "https://i.pinimg.com/1200x/10/47/75/1047757c6958d2a4146d0f09028dc713.jpg";
                ...
                >
                    ...
                    >
                        ...
                        <View className="absolute top-6 left-6">
                            <View
                                className="flex-row items-center px-3 py-1.5 rounded-full border border-white/10 bg-black/30 backdrop-blur-md"
                            >
                                <Ionicons name={CATEGORY_ICONS[categoryKey]} size={10} color={color} />
                                ...
                                <View className="h-2 w-full bg-slate-900 rounded-full overflow-hidden border border-white/5 relative">
                                    ...
                                    <View
                                        ...
                                        style={{
                                            ...
                                            shadowOpacity: 1,
                                            shadowRadius: 10, // Strong neon glow
                                            elevation: 5
                                        }}
                                    />
                                </View>
